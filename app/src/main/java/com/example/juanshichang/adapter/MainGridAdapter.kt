...
class MainGridAdapter(context: Context, data:  List<HomeBean.Items>) : BaseAdapter() {
    var context: Context? = null
    var datas:  List<HomeBean.Items>? = null
    ...
    override fun getView(p: Int, v: View?, vg: ViewGroup?): View {
        ...
        holder.tv.text = datas!![p].name
        when(p){
            0->{
                Glide.with(context!!).load(datas!![p].icon)
    ...
    inner class ViewHolder {
        lateinit var iv: com.qmuiteam.qmui.widget.QMUIRadiusImageView
