...
class ClassTypeActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun initView() {
        ...
        if (null != getIntent().getStringExtra("keyword")) {
            ...
            cargoList(keyWord.trim(), page,20,1)
        } else {
...
//    }
     ...
     *  商品搜索
     */
    private fun cargoList(keyword: String, page: Int,page_size:Int,sort_type:Int) {
        HttpManager.getInstance().post(Api.SEARCH, Parameter.getSearchMap(keyword, page,page_size,sort_type), object :
            Subscriber<String>() {
